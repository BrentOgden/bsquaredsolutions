                ...
                <div className="flex md:justify-between">
                    ...
                    <div className='ml-20 md:ml-0'>
                        ...
                        <div className="flex space-x-4 text-white">
                            <a href="https://twitter.com/MileHiRocks5280" aria-label="Twitter" className="hover:text-gray-700" target='_blank'><FaTwitter size={30} /></a>
                            <a href="https://youtube.com/@MileHiMayhem303" aria-label="YouTube" className="hover:text-gray-700" target='_blank'><FaYoutube size={30} /></a>
                            <a href="https://instagram.com/MileHiRocks5280" aria-label="Instagram" className="hover:text-gray-700" target='_blank'><FaInstagram size={30} /></a>
                        </div>
                    </div>
                </div>
